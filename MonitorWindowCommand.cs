...
namespace VSIXIvson
{
  ...
  internal sealed class MonitorWindowCommand
  {
    ...
    {
      paneWindow = this.package.FindToolWindow(typeof(MonitorWindow), 0, true);
      if ((null == paneWindow) || (null == paneWindow.Frame))
      {
        throw new NotSupportedException("Cannot create tool window");
      }

      IVsWindowFrame windowFrame = (IVsWindowFrame)paneWindow.Frame;
